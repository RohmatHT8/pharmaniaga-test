...
export default function PendaftaranSarana() {
            ...
            <div className='relative z-10'>
                <div className='flex mx-auto border py-5 justify-center gap-20'>
                    ...
                    <div className='w-[25rem] bg-white h-[85vh] rounded-lg shadow-md px-8 py-4 overflow-auto'>
                        <p className='font-semibold text-gray-700 mb-5'>Input Data Perusahaan</p>
                        <form>
                            <select className='input-control'>
                                <option>Bidang Usaha *</option>
                            </select>
                            <input type={"text"} className="input-control" placeholder='Nama perusahaan *' />
                            <input type={"text"} className="input-control" placeholder='NPWP Perusahaan *' />
                            <input type={"text"} className="input-control" placeholder='Alamat Sesuai NPWP *' />
                            <select className='input-control'>
                            ...
                            <input type={"text"} className="input-control" placeholder='Kode Pos *' />
                            <p className='text-xs font-bold'>Upload Kelengkapan Data</p>
                            <span className='bg-sky-600 text-xs text-white font-semibold w-full block py-1 px-2 rounded-t-md'><HiOutlineDocumentText className="mb-1 inline text-base" /> NIB</span>
                            <label>
                        ...
                        <button className='bg-orange-400 text-xs p-2 text-white rounded-md w-full mt-2 hover:bg-orange-500' onClick={handleSubmit}>Selanjutnya</button>
                    </div>
