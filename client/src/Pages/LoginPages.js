    ...
    return (
        <section className='h-screen w-screen overflow-hidden'>
            <div className='bg-colorOne w-full h-[60vh] relative'>
                ...
                <div className='p-20'>
                    <h1 className='text-yellow-900 text-3xl font-[500]'>Selamat Datang di Solusi <br />Perangkat Lunak Farmasi</h1>
                    <p className='text-lg'>Sistem Manajemen Apotek Online</p>
                </div>
                <div className='absolute bottom-5 z-10 right-0'>
                    <img src="./img/bgLogin.png" width={"500px"} alt="bg-login" />
            ...
            <div className='bg-colorTwo w-full h-[40vh] text-center relative'>
                <h1 className='font-semibold text-yellow-900'>Silahkan masuk kedalam akun anda dan kelola apotek anda</h1>
